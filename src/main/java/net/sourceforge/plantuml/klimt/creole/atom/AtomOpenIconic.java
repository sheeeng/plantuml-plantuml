...
public class AtomOpenIconic extends AbstractAtom implements Atom {

	private final OpenIconic openIconic;
	private final double factor;
	private final Url url;
	private final HColor color;

	public AtomOpenIconic(HColor newColor, double scale, OpenIconic openIconic, FontConfiguration fontConfiguration,
			Url url) {
		this.url = url;
	...
	private TextBlock asTextBlock() {
		return TextBlockUtils.withMargin(openIconic.asTextBlock(color, factor), 1, 0);
	}
