...
public class MTRandom extends Random {
	 ...
	 * serialization of its internal state and it may even be necessary to implement
	 ...
	 * being initialized with a seed value obtained by calling
	...
	/**
	 * This version of the constructor can be used to implement identical behavior
	 ...
	 * existing C code into Java where identical behavior is required.
	 * <p>
	 ...
	 * 
	 * @param compatible Compatibility flag for replicating original behavior.
	 */
	 ...
	 * <p>
	 * If this instance was initialized in 'compatibility' mode then this method
	 * will only use the lower 32 bits of any seed value passed in and will match
	 * the behavior of the original C code exactly with respect to state
	 * initialisation.
	 * 
	 ...
	 * first and then use that to re-seed the instance. The behavior of the class
